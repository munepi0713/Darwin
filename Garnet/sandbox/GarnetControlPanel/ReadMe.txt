========================================================================
    アプリケーション: GarnetControlPanel プロジェクトの概要
========================================================================

この GarnetControlPanel アプリケーションは、AppWizard により作成されました。  

このファイルには、GarnetControlPanel 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

GarnetControlPanel.vcxproj
...
GarnetControlPanel.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、GarnetControlPanel.pch 
